              ...
              <div className="card-footer bg-white p-4">
                ...
                <div className="row g-4">
                  <div className="col-md-6">
                    <label className="form-label fw-bold">1. Type Your Full Name</label>
                  ...
                  <div className="col-md-6">
                    <label className="form-label fw-bold">2. Location (City, Province)</label>
                  ...
                  <div className="col-md-12 mt-2">
                    <div className="form-check">
                      ...
                      <label className="form-check-label fw-bold ms-2" htmlFor="agreeCheck" style={{ fontSize: '15px' }}>
                        3. I have reviewed the draft return and agree to proceed with the filing.
                      </label>
                    </div>
                  </div>
                </div>
                <div className="text-end mt-4"><button className="btn btn-success btn-lg px-5 shadow-sm" onClick={handleSubmitSignature} disabled={loading || !signatureName.trim() || !locationStr.trim() || !agreedToFile}>{loading ? 'Submitting...' : 'Sign & Complete'}</button></div>
              </div>
            )}
          </div>
        </div>
