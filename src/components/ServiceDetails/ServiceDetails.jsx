    ...
    const cards = [
        {
            ...
            desc2: "“Our experienced tax professionals help you navigate complex tax regulations, ensure compliance, and optimize your tax strategy.“",
            desc3: "Our goal is to simplify the tax process so you can focus on growing your business or managing your personal finances. With our proactive approach, we identify opportunities to minimize tax liabilities and maximize savings. Partner with us for personalized service and a commitment to your financial success.",
            img: img1,
            IndividualCard: [
                { id: 1, title: "Personal Tax Planning", para: "Customized strategies to minimize your tax liabilities and maximize your savings." },
                { id: 2, title: "Corporate Tax Strategies", para: "Expert advice on optimizing your business tax position and ensuring regulatory compliance." },
                { id: 3, title: "International Tax Services", para: "Guidance on navigating complex international tax laws and cross-border transactions." },
                { id: 4, title: "ESTATE CONSULTING", para: "Assistance with accurate and timely tax filings to avoid penalties and audits." },
            ]
        },
        {
            id: 2,
            title: 'Bookkeeping Services',
            desc1: "Maintaining accurate and up-to-date financial records is essential for any business's success. At [Your Company Name], our comprehensive bookkeeping services ensure that your financial information is meticulously managed and easily accessible. ",
            desc2: "Our team of experienced professionals is dedicated to providing you with the highest level of accuracy and efficiency, allowing you to focus on growing your business.",
            desc3: "Our bookkeeping services encompass a wide range of tasks designed to keep your finances in perfect order. From tracking daily transactions to preparing detailed financial statements, we handle every aspect with precision and care. By partnering with us, you gain access to expert advice and support, ensuring that your financial records are always compliant and reflective of your business's true financial health.",
            img: img2,
            IndividualCard: [
                { id: 1, title: "Transaction Recording", para: "We accurately record all your financial transactions to maintain a clear and detailed record of your business activities." },
                { id: 2, title: "Financial Statement Preparation", para: "Our team prepares comprehensive financial statements that provide valuable insights into your company's performance." },
                { id: 3, title: "Reconciliation Services", para: "We ensure that your bank statements, credit card statements, and other financial records are accurately reconciled to prevent discrepancies." },
                { id: 4, title: "Payroll Management", para: "We handle all aspects of payroll processing, ensuring your employees are paid accurately and on time." },
            ]
        },
        {
            id: 3,
            title: 'Taxes',
            desc1: "Navigating the complex world of taxes can be daunting, whether you're an individual, a small business owner, or a large corporation. Our team of experienced tax consultants is here to simplify the process for you. We provide tailored tax solutions that ensure compliance, optimize your financial strategies, and help you save money.",
            desc2: "With our comprehensive understanding of tax laws and regulations, we guide you through every step, from preparation to filing and beyond.",
            desc3: "At our firm, we believe in offering personalized service to meet your unique tax needs. Our goal is to minimize your tax liabilities and maximize your returns, allowing you to focus on what matters most – growing your business or enjoying your personal achievements. Trust us to handle your taxes with the utmost professionalism and expertise, ensuring you get the most favourable outcomes.",
            img: img3,
            IndividualCard: [
                { id: 1, title: "Personal Tax Services", para: "Comprehensive solutions for individuals to optimize their tax returns and ensure compliance." },
                { id: 2, title: "Business Tax Services", para: "Expert advice and services to help small and medium-sized businesses manage their taxes effectively." },
                { id: 3, title: "Corporate Tax Services", para: "Tailored strategies for large corporations to navigate complex tax landscapes and achieve financial efficiency." },
                { id: 4, title: "Tax Planning and Advisory", para: "Proactive tax planning and advisory services to help you make informed financial decisions year-round." },
            ]
        },
        {
            id: 4,
            title: "Business Registration",
            desc1: "Launching a business is a thrilling leap into the world of entrepreneurship. Your vision takes shape, and the possibilities for growth seem endless. However, the initial legal hurdles of registration shouldn't become a stumbling block on your exciting journey. Many entrepreneurs find themselves bogged down by the complexities of choosing a business structure, conducting name availability checks, and navigating government filings. ",
            desc2: "This can significantly delay your launch and distract you from focusing on your core business idea.",
            desc3: "That's where our team of experienced tax consultants comes in. We provide comprehensive business registration services designed to streamline your startup process and ensure complete compliance from the get-go. We understand the intricacies involved in forming a new business, and we're here to guide you through every step. Our team takes the burden off your shoulders, so you can focus on what truly matters – building your dream business and turning your vision into reality.",
            img: img4,
            IndividualCard: [
                { id: 1, title: "Entity Selection", para: "Helping you choose the right business structure that aligns with your goals and minimizes tax liabilities." },
                { id: 2, title: "Documentation Preparation", para: "Assisting in the preparation and filing of necessary documents to establish your business legally." },
                { id: 3, title: "State and Federal Compliance", para: "Ensuring adherence to all state and federal regulations to avoid penalties and legal complications." },
        ...
        },
        {
            ...
            IndividualCard: [
                ...
                { id: 3, title: "Audit Defence", para: " We defend your tax positions with clear communication." },
                { id: 4, title: "Post-Audit Guidance", para: "We provide guidance on next steps, like filing amended returns." },
            ]
        },
        {
            id: 6,
            ...
            IndividualCard: [
                ...
                { id: 3, title: "Employee Self-Service Portal", para: "Providing employees with easy access to their payroll information." },
                { id: 4, title: "Direct Deposit Services", para: "Facilitating seamless and secure direct deposits to employee accounts." },
            ]
        },
        {
            id: 7,
            ...
            IndividualCard: [
                ...
                { id: 3, title: "Tax Compliance Reviews", para: "Conduct thorough reviews to ensure compliance with ever-changing tax laws and regulations." },
                { id: 4, title: "Risk Management and Advisory", para: "Identify and mitigate tax-related risks with expert advisory services." },
            ]
        },
        {
            id: 8,
            ...
            IndividualCard: [
                ...
                { id: 3, title: "Annual Reports", para: "Regularly required filings that provide essential updates on your corporation's financial status and operational activities." },
                { id: 4, title: "Meeting Minutes", para: "Accurate records of corporate meetings, ensuring all decisions and discussions are documented for legal compliance." },
            ]
        }
    ];
